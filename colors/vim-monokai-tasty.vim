...
call Highlight("Exception", s:bright_blue, s:none, s:bold)
call Highlight("MatchParen", s:bright_blue, s:none, s:bold_underline)
call Highlight("Include", s:bright_blue, s:none, s:none)
call Highlight("Conditional", s:bright_blue, s:none, s:none)
call Highlight("Define", s:bright_blue, s:none, s:none)
call Highlight("Debug", s:bright_blue, s:none, s:none)
call Highlight("Delimiter", s:bright_blue, s:none, s:none)
call Highlight("Keyword", s:bright_blue, s:none, s:none)
call Highlight("Macro", s:bright_blue, s:none, s:none)
call Highlight("Operator", s:bright_blue, s:none, s:none)
call Highlight("PreProc", s:bright_blue, s:none, s:none)
call Highlight("Statement", s:bright_blue, s:none, s:none)
call Highlight("Repeat", s:bright_blue, s:none, s:none)
...
call Highlight("jsObjectColon", s:bright_blue, s:none, s:none)
call Highlight("jsObjectSeparator", s:purple, s:none, s:none)
call Highlight("jsNoise", s:white, s:none, s:none)
call Highlight("jsGlobalNodeObjects", s:bright_blue, s:none, s:none)
...
call Highlight("jsxEqual", s:bright_blue, s:none, s:none)
...
" GraphQL
call Highlight("graphqlStructure", s:bright_blue, s:none, s:none)
...
call Highlight("xmlEqual", s:bright_blue, s:none, s:none)
...
call Highlight("CalToday", s:bright_blue, s:none, s:bold)
...
call Highlight("mkdHeading", s:bright_blue, s:none, s:none)
...
call Highlight("VimwikiHeaderChar", s:bright_blue, s:none, s:bold)
